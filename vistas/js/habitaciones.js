...
$(enlacesHabitaciones[enlacesHabitaciones.length - 1]).css({
	"border-right": 0
})

/*=============================================
			ENLACES HABITACIONES
el siguiente codigo nos permite que funcione el 
sub menu para cada tipo de habitacion y nos lleva la informacion de la base de datos al front
===============================¿==============*/
...
$(".cabeceraHabitacion ul.nav li.nav-item a").click(function(e) {
	...
	/*=============================================
				AJAX HABITACIONES
				El siguiente codigo muestra las imagenes de cada habitacion por separado utilizando ajax
	=============================================*/
	...
	for (var i = 0; i < listaSlide.length; i++) {
		...
		$(".slideHabitaciones .slide-inner .slide-area").css({
			"height": alturaSlide + "px"
		})
		$(listaSlide[i]).html("");
